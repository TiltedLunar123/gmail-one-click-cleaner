...
Gmail One-Click Cleaner is a Chrome extension that bulk deletes low-value Gmail clutter in one click. It runs safe preset searches for promos, social updates, newsletters, no-reply mail, and large attachments, with a simple progress screen, so you can free up storage and keep important messages easy to find.
